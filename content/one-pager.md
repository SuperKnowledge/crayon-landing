...
**How people consume software is about to change too.** Today it's a slog: open the App Store, read reviews, download, sign up, sit through onboarding, hope it's the right tool. Most of what's there is generic — built for the broadest audience, because that's the only economics that worked when software was expensive to make. AI changes that. Software is becoming cheap and specific, and supply is about to explode. Every other medium that got cheap to produce — video, music, news — made the same shift: **from active search to passive arrival**. Software is next. It'll reach you the same way everything else does now — a friend in a group chat, a favorite influencer, a QR code on the table — and no one will go through download-signup-onboarding for each one. The form that fits is the mini-app: no download, no signup, instant to open, contextual, often used once. Software's TikTok moment.
