      ...
      <div className="relative z-10 row-start-2 flex flex-col items-center justify-center px-6 py-10 md:py-12 gap-8 page-container max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-[1.15]">
            <span className="gradient-text inline-block pb-1">Terms of Service</span>
          </h1>
        ...
        >
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">2. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">3. App Creation and Ownership</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">4. User Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">5. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">6. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">7. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">8. Contact Us</h2>
            <p>
