    ...
    <main className="landing-page relative grid min-h-[100svh] grid-rows-[auto,1fr,auto] overflow-hidden main-root">
      ...
      <div className="relative z-10 row-start-2 flex flex-col items-center justify-center px-6 py-10 md:py-12 gap-8 page-container max-w-4xl mx-auto">
        ...
        >
          <Link
            href="/"
            className="text-[#68635b] hover:text-[#171717] transition-colors flex items-center gap-2 text-sm"
          >
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-[1.15]">
            <span className="gradient-text inline-block pb-1">Privacy Policy</span>
          </h1>
          <p className="text-[#68635b] text-lg">
        ...
        <motion.div
          ...
          className="w-full text-[#2b2722] space-y-8 text-left"
        >
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">1. Introduction</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">2. Information We Collect</h2>

            <h3 className="text-xl font-semibold mb-2 text-[#171717]">A. Information You Provide to Us</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 text-[#171717]">B. Information Collected Automatically</h3>
            <ul className="list-disc pl-5 mb-4 space-y-2">
              <li>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">3. How We Use Your Information</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">4. Data Sharing and Disclosure</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">5. Your Privacy Rights</h2>
            <p className="mb-4">
            ...
            <p className="mt-4">
              To exercise these rights, please contact us at <a href="mailto:support@crayon-ai.com" className="text-[#e8402a] hover:underline">support@crayon-ai.com</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">6. Data Retention &amp; Security</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">7. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">8. Changes to This Privacy Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-[#171717]">9. Contact Us</h2>
            <p>
              If you have any questions about this Privacy Policy, please contact us at{" "}
              <a href="mailto:support@crayon-ai.com" className="text-[#e8402a] hover:underline">
